...
> **Das Muster:** Je weiter rechts im Spektrum (eigene Modelle, eigene Infrastruktur, EU-Eigentümer), desto geringer das CLOUD-Act-Risiko. Plaud demonstriert das Worst-Case: CN-Firma sendet Arzt-Patienten-Audio an US-Server. myScribe demonstriert das Best-Case: eigenes NLP, On-Premise, keine Cloud. Averbis zeigt die **typische Hybridlösung**: die eigene NLP-Engine (Health Discovery) ist souverän, aber für generative KI (Arztbrief-Schreibung) wird auf Azure OpenAI zurückgegriffen — ein Muster, das sich bei vielen EU-Anbietern wiederholt, die für klassische Analyse souverän arbeiten, für LLM-Funktionen aber US-Infrastruktur benötigen.
