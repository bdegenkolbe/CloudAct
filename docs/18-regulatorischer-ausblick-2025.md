...
|---|---|---|
| **TI 2.0 (Telematikinfrastruktur)** | Migration ab 2025, Vollbetrieb 2027 | Cloud-basierte TI-Gateways ersetzen Hardware-Konnektoren. Offene Frage: US-Konzerne als Gateway-Betreiber? (→ [§18.1](#181-telematikinfrastruktur-ti-20-was-sich-durch-die-migration-andert)) |
| **GeDIG** | Referentenentwurf April 2026 | ePA-Ausbau auf 20 Mio. Nutzer, automatische FDZ-Ausleitung Ende 2026. Vergrößert CLOUD-Act-Angriffsfläche erheblich. (→ [§18.2](#182-gedig-2026-wie-das-neue-digitalgesetz-die-cloud-act-exposition-erhoht)) |
| **EHDS (European Health Data Space)** | Ab 2026 schrittweise | Sekundärnutzung erhöht Datenpool-Attraktivität. Keine Cloud-Infrastrukturvorgaben — CLOUD-Act-Lücke. (→ [§18.3](#183-ehds-der-europaische-gesundheitsdatenraum-und-seine-grenzen)) |
| **Schrems III (EuGH)** | Anhängig | Kippt das DPF, ändert sich das Enforcement-Bild schlagartig — sofortiger Handlungsdruck für alle US-Cloud-Nutzer. (Analyse: → [§9.1](09-rechtliche-abkommen-zwischen-eu-und-usa.md#91-das-data-privacy-framework-die-dritte-runde)) |
| **FISA § 702 Verlängerung** | Auslaufdatum 20. April 2026 | Verlängerung ohne Reformen zementiert RISAA-Erweiterungen. Ablauf würde US-Zugriff temporär einschränken. (Analyse: → [§3.2](03-die-vier-us-zugriffsebenen-im-detail.md#32-fisa-702-und-risaa-2024-die-unterschatzte-gefahr)) |
...
| **SharePoint On-Premise End-of-Life** | Juli 2026 | SharePoint 2013/2016/2019 verliert Support. Erzwingt Entscheidung: SharePoint Online (US-Cloud) oder souveräne Alternative (→ [§8.3](08-der-vollstaendige-eu-plattformstack.md#83-die-vollstandige-souverane-zielarchitektur)). |
| **STACKIT Lübbenau-RZ** | Fertigstellung 2027 | 11 Mrd. EUR, bis zu 100.000 GPUs. Erster EU-Anbieter mit Hyperscaler-Kapazität. (Analyse: → [§5.5](05-anbieterbewertung.md#55-juristische-detailanalysen), [§7.2](07-das-hyperscaling-problem.md#72-die-kapazitatslucke-ehrliche-zahlen)) |
| **Euro-Office / Office.eu** | Rollout ab März–Q2 2026 | Erste produktionsreife souveräne M365-Alternative. (Analyse: → [§8.3](08-der-vollstaendige-eu-plattformstack.md#83-die-vollstandige-souverane-zielarchitektur)) |
| **BSI C5:2026** | Veröffentlicht 7. April 2026 | 168 Kriterien (Nachfolger C5:2020). Technische Sicherheit modernisiert (Container, PQC, Confidential Computing). Souveränität weiterhin nicht geprüft — separate Kriterien angekündigt. (Analyse: → [§5.3](05-anbieterbewertung.md#53-zertifizierungsstandards-im-vergleich)) |
| **ANSSI-BSI Souveränitätskriterien** | Joint Statement 17. Nov. 2025 | ANSSI und BSI entwickeln gemeinsam Souveränitätskriterien auf Basis des EU Cloud Sovereignty Framework. Drei-Stufen-Progressionsmodell. Veröffentlichung "in Kürze". (Analyse: → [§5.3](05-anbieterbewertung.md#53-zertifizierungsstandards-im-vergleich)) |
...
Die CLOUD-Act-Exposition der heutigen TI ist in [§12.8](12-marktbeispiele.md#128-eintrittspfad-6-telematikinfrastruktur-souveran-in-der-governance-exponiert-im-betrieb) dokumentiert: IBM betreibt zwei Kerndienste (Rezeptserver, Identity Provider), Arvato Systems trägt die Sicherheitsinfrastruktur mit US-Technologieabhängigkeit. An dieser Bestandsaufnahme ändert sich kurzfristig nichts. Was sich ändert, ist die Architektur selbst.
